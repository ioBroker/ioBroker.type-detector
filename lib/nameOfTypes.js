const NameOfTypes = {
    ...
    coAlarm: { label: 'CO alarm sensor', description: 'If the carbon monoxide sensor is alarmed (true) or not (false).' },
    contact: { label: 'Contact sensor', description: 'Generic contact sensor for cases where it is not known whether it is a window, a door or something else: contact closed - true, contact open - false.' },
    ...
    fan: { label: 'Fan', description: 'Fan controlled by a speed mode. Could optionally have a continuous speed level, swing, airflow direction and an ON/OFF switch.' },
    ...
    percentage: { label: 'Percentage slider', description: 'Same as slider, but from 0 to 100%' },
    pump: { label: 'Pump', description: 'Pump that can be switched on and off. Could optionally report its level, temperature, pressure and flow.' },
    ...
    electricity: { label: 'Electricity measurement', description: 'Device that only measures electricity: power, current, voltage, consumption or frequency. At least one of them must be present.' },
