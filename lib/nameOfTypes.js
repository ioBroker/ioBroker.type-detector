const NameOfTypes = {
    ...
    location_one: { label: 'GPS Location in single state', description: 'GPS location, where longitude and latitude are stored in one state, like `longitude;latitude` - `8.40435;49.013506`.' },
